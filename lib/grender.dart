...
class genderscreen extends StatelessWidget {
  ...
  genderscreen({Key? key, required this.user}) : super(key: key);
          ...
          child: ListView(
            ...
            children: [
              SizedBox(
                height: 70,
                child: ListTile(
                  title: Text('マッチョな男性以外はご利用できません！',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                  subtitle: Text('マッチョな男性じゃないと判断した場合は強制退会を行うことがございます。',
                      style: TextStyle(
                        fontSize: 15,
                        color: Color(COLOR_PRIMARY),
                      )),
              ...
              SizedBox(
                height: 70,
                child: ListTile(
                  title: Text('女性の方18歳未満の方は使用しないでください！',
                      style: TextStyle(
